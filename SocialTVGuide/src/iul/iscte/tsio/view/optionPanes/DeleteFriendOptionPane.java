...
public class DeleteFriendOptionPane {
	...
	public DeleteFriendOptionPane() {
		...
		while (!exit) {
			int result = JOptionPane.showOptionDialog(null, panel,
					Labels.TITLE_DELETEFRIEND_PANE.getValue(),
			...
			if (result == JOptionPane.OK_OPTION) {
				...
				if (usernames.contains(name)) {
					System.out.print("Deleting friendship with \"" + name
							+ "\"... ");
					...
					if (opResult) {
						String message = String
								.format(Labels.TEXT_SUCCESSDELETINGFRIEND_DELETEFRIEND_PANE
										.getValue(), name);
						JOptionPane
								.showMessageDialog(
										null,
										message,
										Labels.TITLE_SUCCESSDELETINGFRIEND_DELETEFRIEND_PANE
												.getValue(),
						...
						JOptionPane
								.showMessageDialog(
										null,
										Labels.TEXT_ERRORDELETINGFRIEND_DELETEFRIEND_PANE
												.getValue(),
										Labels.TITLE_ERRORDELETINGFRIEND_DELETEFRIEND_PANE
												.getValue(),
					...
					JOptionPane
							.showMessageDialog(
									null,
									Labels.TEXT_INVALIDDELETINGFRIEND_DELETEFRIEND_PANE
											.getValue(),
									Labels.TITLE_INVALIDDELETINGFRIEND_DELETEFRIEND_PANE
											.getValue(),
									JOptionPane.ERROR_MESSAGE);
				}
			} else {
